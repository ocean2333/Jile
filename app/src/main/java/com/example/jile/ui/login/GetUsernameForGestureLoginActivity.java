...
public class GetUsernameForGestureLoginActivity extends AppCompatActivity {
    private String username;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_get_username_for_gesture_login);
        Log.d("?", "onCreate: ");
    ...
    private boolean checkIsUserExists(String username){
        ...
        if(user==null){
            Toast.makeText(GetUsernameForGestureLoginActivity.this,"用户不存在",Toast.LENGTH_SHORT).show();
            return false;
        }else{
            return true;
        }
